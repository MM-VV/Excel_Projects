...
The dataset used for this project contains real-world data science job information from 2023. Utilizing data from https://datanerd.tech/, which provides a foundation for analyzing data using Excel. 
...
As a data enthusiast navigating the job market, I undertook this Excel-based project to gain deeper insights into the data science industry. Using a dataset compiled from real-world job postings, I explored trends in job titles, salaries, locations, and in-demand skills. Leveraging Excel tools such as Power Query, PivotTables, DAX, and interactive charts, I identified strong correlations between specific skill combinations and higher salary outcomes — particularly in Python, SQL, and cloud technologies.

Through this project, I aimed to better understand what employers value most and to create a practical reference for aspiring data professionals targeting higher-paying roles.